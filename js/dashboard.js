(async () => {
  ...
  const kazakhA1 = [...Array(30)].filter((_,i)=>completed.has(`kz-a1-${String(i+1).padStart(2,'0')}`)).length;
  ...
  box.innerHTML =
    ...
    card({
      ...
      percent:Math.round(kazakhA1/30*100),
      extra:'Бастауыш деңгейден Жоғары деңгейге дейін. KZ-A1 содержит 30 уроков.'
    });
})();